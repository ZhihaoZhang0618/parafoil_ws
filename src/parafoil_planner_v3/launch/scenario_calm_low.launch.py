...
def generate_launch_description() -> LaunchDescription:
    ...
    guidance_params = PathJoinSubstitution([planner_share, "config", "guidance_params_calm_low.yaml"])
    sim_params = PathJoinSubstitution([sim_share, "config", "params.yaml"])
    sim_params_override = PathJoinSubstitution([sim_share, "config", "params_calm_low.yaml"])
